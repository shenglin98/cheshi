    ...
    <div class="subject" v-if="$route.path == '/index'">
      <div class="body">
        <div class="module_list">
          ...
          >
            <van-image class="link_icon" :src="'data:image/jpeg;base64,'+item.funimgurl" />
            <div class="link_text">{{ item.funcname}}</div>
          </div>
          <!-- <template>
