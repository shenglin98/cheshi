...
import { getListData, GetIdCardInfo } from "@/api/reservation.js";
export default {
  name: "",
  ...
  mounted() {
    ...
    // 从首页切换登记人跳转来的    this.$route.query.pageStatus = addUser
    this.$route.query.pageStatus && !!this.$route.query.pageStatus
    ...
    handleSaveUserInfo() {
      ...
      addOrUpdateMyFamily(this.pageForm)
        .then((res) => {
          ...
          this.pageStatus = "list";
          this.handleResetPageForm();
          if (this.$route.query.pageStatus == "addUser") {
            this.$router.push({
              path: "/",
              query: {
                isToggleFlag: true,
