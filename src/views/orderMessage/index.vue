            ...
            <table class="table">
              <thead>
                <tr>
                  ...
                  <th class="th" v-if="item.viewgroup != 3">提示</th>
              ...
              <tbody>
                ...
                >
                  <td>{{ user.itemname }}</td>
                  <td>{{ user.result }}</td>
                  <td class="th" v-if="item.viewgroup != 3">
                    <!-- :style="{
                      color:
                        user.healthstatus == 1
                          ? 'red'
                  ...
                  <td class="th" v-if="item.viewgroup != 3">{{ user.unit }}</td>
                  <td v-if="item.viewgroup != 3 && user.resexp != ''">
                    {{ user.resexp }}
                  </td>
                  <td v-else>
                    <span v-show="user.resupper && user.reslower">{{
                      `${user.reslower} - ${user.resupper}`
                    }}</span>
                    <span v-show="user.resupper && !user.reslower">
                      {{ user.resupper }}
                    </span>
                    <span v-show="user.reslower && !user.resupper">
                      {{ user.reslower }}
                    </span>
                  </td>
                  <!-- <td
